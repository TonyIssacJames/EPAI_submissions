...
House_of_Cards =[Card('2','clubs'), Card('3','clubs'), Card('4','clubs'), Card('5','clubs'),  Card('6','clubs'),\
                    Card('7','clubs'), Card('8','clubs'), Card('9','clubs'), Card('10','clubs'), Card('jack','clubs'),\
                 ...
                 Card('2','diamonds'), Card('3','diamonds'), Card('4','diamonds'), Card('5','diamonds'),  Card('6','diamonds'),\
                    Card('7','diamonds'), Card('8','diamonds'), Card('9','diamonds'), Card('10','diamonds'), Card('jack','diamonds'),\
                 ...
                 Card('2','hearts'), Card('3','hearts'), Card('4','hearts'), Card('5','hearts'),  Card('6','hearts'),\
                    Card('7','hearts'), Card('8','hearts'), Card('9','hearts'), Card('10','hearts'), Card('jack','hearts'),\
                    Card('queen','hearts'), Card('king','hearts'), Card('ace','hearts'),\
                 Card('2','spades'), Card('3','spades'), Card('4','spades'), Card('5','spades'),  Card('6','spades'),\
                    Card('7','spades'), Card('8','spades'), Card('9','spades'), Card('10','spades'), Card('jack','spades'),\
                    Card('queen','spades'), Card('king','spades'), Card('ace','spades')]

#5_card_P1_Royal_Flush_P2_Combinations
Test_Card_Set_RF_vs_Combinations = [ None, None, 'Draw' ]
...
def test_if_all_cards_are_created_using_normal():
    ...
    assert True, "All cards were created"
...
def test_5_card_P1_Royal_Flush_P2_Combinations():
    ...
    for player1_hand, player2_hand, true_result in test_set:
